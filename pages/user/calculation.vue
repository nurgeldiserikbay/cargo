<template>
  <v-container class="flex-grow-1 d-flex flex-col justify-start items-center pt-10">
    <v-card class="d-flex flex-col items-center w-full max-w-1200px pt-8 px-8 pb-10 rounded-lg">
      <div class="text-h4 mb-6 text-left capitalize">{{ $t('pages.calculation') }}</div>
      <div class="w-full text-(lg)">
        <div class="flex justify-between items-center gap-8">
          <div class="flex justify-start items-center gap-2 text-h6 leading-none gap-4">
        ...
        <div class="flex justify-between items-center gap-8">
          <div class="flex justify-start items-center gap-2 text-h6 leading-none gap-4">
            <v-icon icon="mdi mdi-cash-multiple" color="black" size="x-large"></v-icon>
